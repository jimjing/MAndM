...
\newtheorem{define}{\textbf{Definition}}[section]

\newtheorem{problem}{\textbf{Problem}}

\newcommand{\todo}[1]{\textcolor{blue}{\emph{\bf#1}}}
...
%\title{\LARGE \bf High-level Robot Control: Negotiate to Achieve Our Goals Together}
\title{\LARGE \bf CS 6751 Intro to Mobile Robot Manipulation Project Proposal}


\author{Scott Hamill, Jim Jing, Catherine Wong% <-this % stops a space
}

%\usepackage{fullpage}
%\usepackage[margin=1in]{geometry}
\usepackage[top=0.3in, bottom=0.5in, left=1in, right=1in]{geometry}
